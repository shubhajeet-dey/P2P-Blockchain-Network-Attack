...
def generate_records_of_one_attack_node_txt(node):
    ...
    with open(filename, 'w') as f:
        ...
        if node.cntSuccessfulBlocks == 0:
            ...
            f.write("\n\nMPU_node_adv (Number of blocks generated by this adversary node in the Longest Public Chain of the tree/Total number of blocks mined by this adversary overall): "+ str(cntBlocksInLongestChain/(node.cntSuccessfulBlocks-len(node.privateChain))))
