...
def generate_records_of_one_node_txt(node):
    ...
    with open(filename, 'w') as f:
        ...
        for blockHash in adjacency_list.keys():
            ...
            if maxLengthOfBlockChain < depth:
        ...
        if node.cntSuccessfulBlocks == 0:
            f.write("\n\nRatio (Number of blocks generated by this node in the Longest Chain of the tree/Total Blocks created by this node): 0/0")
        else:
            f.write("\n\nRatio (Number of blocks generated by this node in the Longest Chain of the tree/Total Blocks created by this node): "+ str(cntBlocksInLongestChain/node.cntSuccessfulBlocks))
...
def generate_records_of_one_node_html(node):
    ...
    with open(filename, 'w') as f:
        ...
        for blockHash, blockInfo in node.blocksSeen.items():
            ...
            if maxLengthOfBlockChain < blockInfo["Block"].depth:
        ...
        # The ratio of the number of blocks generated by each node in the Longest Chain of the tree to the total number of blocks it generates.
        if node.cntSuccessfulBlocks == 0:
            f.write("<p>Ratio (Number of blocks generated by this node in the Longest Chain of the tree/Total Blocks created by this node): <strong>0/0</strong></p>\n")
        else:
            f.write("<p>Ratio (Number of blocks generated by this node in the Longest Chain of the tree/Total Blocks created by this node): <strong>{}</strong></p>\n".format(str(cntBlocksInLongestChain/node.cntSuccessfulBlocks)))
        f.write("</div>\n")
